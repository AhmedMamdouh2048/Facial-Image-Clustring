...
public:
    ...
    matrix* SubBool(matrix<bool>* m,bool negative) const;             //Subtraction between any type of matrix and matrix of boolean between any type of matrix and a boolean matrix
    matrix* dot_T(matrix* m) const;                      //Efficient dot product using transpose
    matrix* dot_Tiled(matrix* m) const;                  //Efficient dot product using tiles
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename E>
matrix<E>* matrix<E>::SubBool(matrix<bool>* m,bool negative) const
{
	matrix<E>* a = new matrix(row, column);
	if (row == m->Rows() && column == m->Columns())
	{
